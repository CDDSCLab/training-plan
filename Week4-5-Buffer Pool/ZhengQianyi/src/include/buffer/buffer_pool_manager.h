...
class BufferPoolManager {
 ...
 protected:
  ...
  /**
   * Find page_id in the page table
   * @param[out] frame_id id of frame
   * @return false if the page not in the buffer pool, other true
   */
  bool PageTableMap(page_id_t page_id, frame_id_t *frame_id);

  /**
   * get a Victim page, from free_list or replacer
   * @param[out] frame_id id of frame
   * @return false if all page have pinned, other true
   */
  ...
  /** This latch protects page table*/
  // ReaderWriterLatch mu_page_table_;
  /**This latch protects free_list_*/
  // std::mutex mu_free_list_;
};
}  // namespace bustub
