...
#### Q:![image11](E:\homework\training-plan\training-plan\Week18-TinyKV Raft KV 2C\project2c.assets\image11.png)(3%)Bug 出现时, 最后一个 Entry 的 Index 和访问越界的 Index 的差值绝大多数时候为 5.（2b中的偶现问题)
