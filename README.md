...
| 19 - 20 |     Agent     | Agnet 项目实践, 掌握 Agent 架构基本知识，自己搭建一个 Agent                                                                                                                             | 整理 Agent 基础知识，实现项目 <br />[hello-agents](https://github.com/datawhalechina/hello-agents) <br />[tRPC-Agent](https://github.com/trpc-group/trpc-agent-go)                                               
