...
int main(){
    ...
    cout << "误报率：" << (double)number/30000 << endl;
    cout << "计算的误报率：" << exp(-BIT_SIZE * log(2) * log(2) / 30000) << endl << endl;
    cout << "测试五万个数字" << endl;
    //插入50000个数字
    number = 0;
    QueryPerformanceFrequency(&nFreq);
    ...
    cout << "误报数：" << number << endl;
    cout << "误报率：" << (double)number / 50000 << endl;
    cout << "计算的误报率：" << exp(-BIT_SIZE * log(2) * log(2) / 50000) << endl << endl;
